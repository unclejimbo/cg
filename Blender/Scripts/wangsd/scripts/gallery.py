...
scene_path = '/home/wangsd/Workspace/foliation-results/outputs/scenes/paper/gallery/'
output_path = '/pub/data/wangsd/images/gallery'
texture_path = '/home/wangsd/Workspace/cg/data/texture/checkerboard_red.png'
